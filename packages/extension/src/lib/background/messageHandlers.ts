import type { AutoLockTimer } from '@/lib/background/autoLockTimer'
import type { KeyStore } from '@/lib/background/keystore'
import type {
  BackgroundMessage,
  BackgroundResponse
} from '@/lib/background/messageTypes'
import type { SessionManager } from '@/lib/background/session'
import type { TokenRefresh } from '@/lib/background/tokenRefresh'
import { base64ToUint8Array, uint8ArrayToBase64 } from '@/lib/crypto'
import { getDefaultSettings, getSettings, setSettings } from '@/lib/storage'
import { getCurrentTab } from '@/lib/tabUtils'
